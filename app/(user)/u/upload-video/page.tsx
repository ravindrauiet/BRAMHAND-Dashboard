            ...
            <div className="pt-24 pb-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="max-w-2xl mx-auto">
                    <div className="mb-8 text-center">
                        <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Upload a Video</h1>
                        <p className="text-slate-500 dark:text-slate-400">Share your full-length content with the world.</p>
                    </div>
